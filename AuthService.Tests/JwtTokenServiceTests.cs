...
namespace ReportingSystem.Tests.Authentication
{
    ...
    public class JwtTokenServiceTests
    {
        ...
        private const string _audience = "local.auth0.audience";
        private const string _issuer = "local.auth0.issuer";
        ...
        public void ValidateHS256Token_IncorrectAudience_ReturnsError()
        {
            ...
            {
                Assert.AreEqual(ex.Message, "Invalid audience: local.auth0.audience");
            }
        }
